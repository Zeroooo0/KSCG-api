...
Route::group(['prefix' => 'v1/public'], function () {
    ...
    Route::get('/competition-results/{competition}', [CompatitionsController::class, 'publicRegistrations']);
...
Route::group(['prefix' => 'v1', 'middleware' => ['auth:sanctum', 'ability:admin,club,commission']], function () {
    ...
    Route::post('/update-u-categories', [CategoriesController::class, 'addYearToUCategories']);
    ...
    Route::get('/certificate-print/{competition}', [CompatitionsController::class, 'publicRegistrations']);
    ...
    Route::post('/membership-document/{membership}', [MembrshipController::class, 'storeMembershipDocument']);
