...
class SpecialPersonnelFormsController extends Controller
{
    ...
    public function store(Request $request, SpecialPersonal $personnel)
    {
        ...
        if($personnel->specialPersonnelForm !== null) {
            ...
            $request->has('policyConfirmation') ? $specialPersonnelForms->update(['policy_confirmation' => true]) : null;
