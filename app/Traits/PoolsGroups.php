...
trait PoolsGroups
{
    ...
    public function rematchBuilding($finalMatch, string $winOneId = null, string $winTwoId = null)
    {
        ...
        $winOneId = $winOneId == null ? $finalMatch->winner_id : $winOneId;
        $winTwoId = $winTwoId == null ? $finalMatch->looser_id : $winTwoId;

        $firstPlace = $pools->where('winner_id', $winOneId)->values();
        $secondPlace = $pools->where('winner_id', $winTwoId)->values();
